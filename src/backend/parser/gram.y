...
DeleteStmt:
			opt_with_clause DELETE_P opt_fk_override FROM relation_expr_opt_alias
...
opt_fk_override:
				CASCADE								{ $$ = FKCONSTR_OVERRIDE_CASCADE; }
			|	RESTRICT							{ $$ = FKCONSTR_OVERRIDE_RESTRICT; }
			| /*EMPTY*/								{ $$ = FKCONSTR_OVERRIDE_NORMAL; }
		;
