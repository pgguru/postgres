...
int force_fk_override = FKCONSTR_OVERRIDE_NORMAL;
...
RI_FKey_noaction_del(PG_FUNCTION_ARGS)
{
	...
	if (force_fk_override == FKCONSTR_OVERRIDE_CASCADE)
...
RI_FKey_cascade_del(PG_FUNCTION_ARGS)
{
	...
	/* If we are overriding the main action to handle as a RESTRICT instead,
	 * handle the main ri_restrict guts */
	if (force_fk_override == FKCONSTR_OVERRIDE_RESTRICT)
		return ri_restrict((TriggerData *) fcinfo->context, false);
